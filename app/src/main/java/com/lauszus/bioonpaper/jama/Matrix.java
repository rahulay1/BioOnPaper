package com.lauszus.bioonpaper.jama;

import com.lauszus.bioonpaper.jama.util.Maths;
...
public class Matrix extends android.graphics.Matrix implements Cloneable, java.io.Serializable {
 ...
 * ------------------------ */
   ...
   */
   ...
   public byte[] getColumnByte (int r) {
      byte[] res = new byte[m];
      for(int j=0; j < m; j++){
         res[j] = (byte) A[j][r];
          //Log.i("getColumnByte: " , String.valueOf(A[j][r]));
          //Log.i("getColumnByte: " , String.valueOf(res[j]));
      }
      return res;
   }
